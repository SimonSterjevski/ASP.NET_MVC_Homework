...
{
    [DbContext(typeof(PizzaAppContextDB))]
    partial class PizzaAppContextDBModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("SEDC.PizzaApp.Domain.Models.Feedback", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Email = "john@123.com", Message = "mmmmmmmm delicious", Name = "John" },
                        new { Id = 2, Email = "johnny@123.com", Message = "Service was awful", Name = "Johnny" }
                    );
                });
